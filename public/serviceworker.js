...
var filesToCache = [
    ...
    "/images/icons/svg/icon-72x72.svg",
    "/images/icons/svg/icon-96x96.svg",
    "/images/icons/svg/icon-128x128.svg",
    "/images/icons/svg/icon-144x144.svg",
    "/images/icons/svg/icon-152x152.svg",
    "/images/icons/svg/icon-192x192.svg",
    "/images/icons/svg/icon-384x384.svg",
    "/images/icons/svg/icon-512x512.svg",
