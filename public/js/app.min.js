...
/* harmony import */ var _modules_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/settings */ "./resources/js/modules/settings.js");
/* harmony import */ var _modules_settings__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_settings__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_custom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/custom */ "./resources/js/modules/custom.js");
/* harmony import */ var _modules_custom__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_custom__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_dz_carousel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/dz.carousel */ "./resources/js/modules/dz.carousel.js");
...
/***/ "./resources/js/modules/custom.js":
/*!****************************************!*\
  !*** ./resources/js/modules/custom.js ***!
  \****************************************/
...
var Gestiss = function () {
  ...
  // Sticky Header
  var handleIsFixed = function handleIsFixed() {
  ...
  // Default Select
  var handleSelectpicker = function handleSelectpicker() {
  ...
  // Menubar Nav Active
  var handleMenubarNav = function handleMenubarNav() {
  ...
  // Message Sheet
  var handleMessageHandle = function handleMessageHandle() {
  ...
  var handleChatBox = function handleChatBox() {
    $(".btn-chat").on("click", function () {
      ...
      var messageEmojiHtml = '<div class="chat-content user">' + '<div class="message-item">' + '<div class="bubble">' + chatEmojiArea + "</div>" + '<div class="message-time">' + actualTime + "</div>" + "</div>" + "</div>";
      if (chatEmojiArea.length > 0) {
        $(".chat-box-area").append(messageEmojiHtml);
      }
      var messageHtml = '<div class="chat-content user">' + '<div class="message-item">' + '<div class="bubble">' + chatMessageValue + "</div>" + '<div class="message-time">' + actualTime + "</div>" + "</div>" + "</div>";
  ...
  // PWA Modal
  var handlePWAModal = function handlePWAModal() {
  ...
  //Tab Slide ============
  var handleTabSlide = function handleTabSlide() {
  ...
  var handleOtp = function handleOtp() {
    if (jQuery("#otp").length > 0) $(".digit-group").find("input").each(function () {
...
/***/ "./resources/js/modules/dz.carousel.js":
/*!*********************************************!*\
  !*** ./resources/js/modules/dz.carousel.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
jQuery(document).ready(function () {
  ...
  if (jQuery(".get-started").length > 0) {
    var swiperGetStarted = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".get-started", {
      speed: 500,
      parallax: true,
      slidesPerView: 1,
      spaceBetween: 10,
  ...
  if (jQuery(".dz-swiper").length > 0) {
    var swiperDefult = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".dz-swiper", {
      speed: 500,
      parallax: true,
      slidesPerView: "auto",
      spaceBetween: 10,
  ...
  if (jQuery(".swiper-center").length > 0) {
    var swiperCenter = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-center", {
      speed: 500,
      parallax: true,
      slidesPerView: "auto",
      spaceBetween: 10,
  ...
  if (jQuery(".team-swiper-4").length > 0) {
    var swiper4 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".team-swiper-4", {
      speed: 1500,
      parallax: true,
      slidesPerView: "auto",
      spaceBetween: 10,
  ...
  if (jQuery(".swiper-slider-full").length > 0) {
    var swiperGetStarted = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-slider-full", {
      speed: 500,
      parallax: true,
      slidesPerView: "auto",
      spaceBetween: 10,
  ...
  if (jQuery(".dz-swiper-gallery").length > 0) {
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".dz-swiper-gallery-thumb", {
      spaceBetween: 10,
      slidesPerView: 4,
      freeMode: true,
      watchSlidesProgress: true
    });
    var swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".dz-swiper-gallery", {
      spaceBetween: 10,
      navigation: {
...
/***/ "./resources/js/modules/settings.js":
/*!******************************************!*\
  !*** ./resources/js/modules/settings.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app.min"], () => (__webpack_require__("./resources/scss/main.scss")))
